...
pkenv install 0.8.6 || error_and_proceed "Install failed"
pkenv use 0.8.6 || error_and_proceed "Use failed"
check_version 0.8.6 || error_and_proceed "Version check failed"
